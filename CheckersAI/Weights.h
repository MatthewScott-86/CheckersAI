...
public:
	...
	virtual void Mutate(double mutationRate, double depthMutationRate) = 0;
...
public:
	...
	virtual void Mutate(double mutationRate, double depthMutationRate) override { throw new exception("Cant be in WeightBase"); };
...
public:
	...
	virtual void Mutate(double mutationRate, double depthMutationRate) override
	{
